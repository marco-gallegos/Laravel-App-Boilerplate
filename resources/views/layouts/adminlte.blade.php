...
<head>
  ...
  <title>Permission system by cbx</title>
  <meta name="csrf-token" content="{{ csrf_token() }}">
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <link rel="stylesheet" href="{{ asset('adminlte/css/bootstrap.min.css') }}">
  <!-- Font Awesome -->
  <!--link rel="stylesheet" href="{{ asset('font-awesome/css/font-awesome.min.css') }} bower_components/font-awesome/css/font-awesome.min.css"-->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
      ...
      <span class="logo-lg">ERP Express</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2017 <a href="">Programadores Express</a>.</strong> All rights reserved.
  </footer>
